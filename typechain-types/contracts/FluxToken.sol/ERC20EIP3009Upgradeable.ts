...
export interface ERC20EIP3009UpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ERC20EIP3009Upgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20EIP3009Upgradeable;
  waitForDeployment(): Promise<this>;

  interface: ERC20EIP3009UpgradeableInterface;
