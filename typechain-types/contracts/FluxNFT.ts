...
export interface FluxNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SUPPLY"
      | "adminMint"
  ...
  encodeFunctionData(
    functionFragment: "getUserMintedCount",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface FluxNFT extends BaseContract {
  connect(runner?: ContractRunner | null): FluxNFT;
  waitForDeployment(): Promise<this>;

  interface: FluxNFTInterface;
  ...
  getUserMintedCount: TypedContractMethod<
    [user: AddressLike],
    [bigint],
    "view"
  >;
  ...
  mint: TypedContractMethod<[_tokenURI: string], [void], "payable">;

  mintBatch: TypedContractMethod<[tokenURIs: string[]], [void], "payable">;

  mintPrice: TypedContractMethod<[], [bigint], "view">;

  mintedCount: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "getUserMintedCount"
  ...
  ): TypedContractMethod<[_tokenURI: string], [void], "payable">;
  getFunction(
    nameOrSignature: "mintBatch"
  ): TypedContractMethod<[tokenURIs: string[]], [void], "payable">;
  getFunction(
    nameOrSignature: "mintPrice"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "mintedCount"
